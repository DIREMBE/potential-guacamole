...
(() => {
  ...
  var REACT_URL_RESPALDO = "https://unpkg.com/react@18.3.1/umd/react.production.min.js";
  var REACT_SRI = "sha384-DGyLxAyjq0f9SPpVevD6IgztCFlnMF6oW/XQGmfe+IsZ8TqEiDrcHkMLKI6fiB/Z";
  var REACT_DOM_URL = "/assets/vendor/react-dom-18.3.1.min.js";
  var REACT_DOM_URL_RESPALDO = "https://unpkg.com/react-dom@18.3.1/umd/react-dom.production.min.js";
  ...
  function loadReactUmd() {
    ...
    /* Primero el archivo que viaja con el sitio; si faltara, unpkg. */
    const conRespaldo = (url, respaldo, sri) =>
      loadScript(url, sri).catch(() => loadScript(respaldo, sri));
    return Promise.all([
      conRespaldo(REACT_URL, REACT_URL_RESPALDO, REACT_SRI),
      conRespaldo(REACT_DOM_URL, REACT_DOM_URL_RESPALDO, REACT_DOM_SRI)
    ]).then(() => void 0);
  }
  function init() {
